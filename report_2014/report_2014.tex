...
\begin{table}[t]
    \begin{minipage}[b]{.45\textwidth }%
        \caption{\strut Principal modes in a set of reflood curves and their interpretation}
...
\centering
\includegraphics[width=\textwidth]{figures/fpc_regfd.pdf}

\captionof{figure}{Principal modes and their effects on the mean function}
\label{fig:fpc_regfd}
